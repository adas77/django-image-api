# Generated by Django 4.2.5 on 2023-09-17 20:13
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('mediafile', models.FileField(unique=True, upload_to=api.models.UploadImage.upload_to)),
                ('resize', models.PositiveIntegerField(default=None, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='Link',
            fields=[
                ...
                ('mediafile', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.uploadimage')),
            ],
        ),
        migrations.AddField(
            model_name='user',
